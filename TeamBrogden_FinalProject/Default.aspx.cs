...
namespace TeamBrogden_FinalProject
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void ResetButton_Click(object sender, EventArgs e)
        {
            ...
            ProblemHeader.Visible = false;
            Testheader.Visible = false;
            LabelProblem.Text="";
            LabelTest.Text = "";
            LabelSolution.Text="";
        ...
        {
            ProblemHeader.Visible=true;
            Testheader.Visible = true;
        ...
        /// <summary>
        /// Makes Header labels vidible, runs logic, makes solution and images visable
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        protected void RhodaButton_Click(object sender, EventArgs e)
        {
            ...
            Image2.Visible = true;
            LabelTest.Text = "height = [0,1,0,2,1,0,1,3,2,1,2,1]";
